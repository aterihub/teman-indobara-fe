<template>
    ...
    :deviceInfo="items"/>
      <div class="flex justify-between mb-6">
        ...
        <div class="button-wrapper">
          <Button type="button" class="outlined__green" label="Add New Admin" @click="newModalToggle" />
        </div>
      </div>
  ...
  import NewAdminModal from '@/components/modal/user/NewAdminModal.vue'
  import EditAdminModal from '@/components/modal/user/EditAdminModal.vue'
  import DeleteAdminModal from '@/components/modal/user/DeleteAdminModal.vue'
