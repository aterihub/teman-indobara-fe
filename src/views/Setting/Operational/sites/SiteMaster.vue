<template>
  ...
  <div class="flex justify-between mb-6">
    <h1 class="title">Sites List</h1>
    <div class="button-wrapper">
      <Button type="button" class="outlined__green" label="Add New Site" @click="newModalToggle" />
    </div>
  </div>
  ...
  <script setup>
  import NewSiteModal from '@/components/modal/site/NewSiteModal.vue'
  import SearchField from '@/components/SearchField.vue'
  import EditSiteModal from '@/components/modal/site/EditSiteModal.vue'
  import DeleteSiteModal from '@/components/modal/site/DeleteSiteModal.vue'
...
import { storeToRefs } from 'pinia'
    ...
    const header = [
      ...
      // { text: "Contractors", value: "contractors", sortable: true },
