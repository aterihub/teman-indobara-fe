<template>
    ...
    :deviceInfo="items"/>
      <div class="flex justify-between mb-6">
        ...
        <div class="button-wrapper">
          <Button type="button" class="outlined__green" label="Add New Vehicle" @click="newModalToggle" />
        </div>
      </div>
        ...
        <EasyDataTable
          ...
          <template #item-operation="item">
            <div class="operation">
              ...
              <svg class="cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="assignVehicle(item)">
  ...
  <script setup>
  import NewVehicleModal from '@/components/modal/vehicle/NewVehicleModal.vue'
  import SearchField from '@/components/SearchField.vue'
  import EditVehicleModal from '@/components/modal/vehicle/EditVehicleModal.vue'
  import DeleteVehicleModal from '@/components/modal/vehicle/DeleteVehicleModal.vue'
  ...
  import { storeToRefs } from 'pinia'
    ...
    const header = [
      ...
      { text: "Purchase Year", value: "purchaseYear", sortable: true },
    ...
    const emits = defineEmits(['assignVehicle'])

    function assignVehicle(item) {
      emits('assignVehicle', item.id)
