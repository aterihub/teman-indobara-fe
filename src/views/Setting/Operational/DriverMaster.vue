<template>
  ...
  <div class="flex justify-end mb-6">
    <div class="flex gap-10">
      <div class="button-wrapper">
        <Button type="button" class="outlined__green" label="Add New Driver" @click="newModalToggle" />
      </div>
    </div>
  </div>
  <div class="table-wrap">
    ...
    :headers="header"
    :items="masterDataStore.vehicles"
    theme-color="#1363df"        
    search-field="name"
  ...
  .title {
    @apply
      text-[24px] font-thin flex justify-start items-center text-[#353535] opacity-80 mb-8
  }
  .device-container {
    @apply 
